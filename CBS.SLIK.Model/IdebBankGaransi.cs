...
namespace SLIK.Model
{
    public class IdebBankGaransi
    {
        ...
        [JsonProperty(PropertyName = "nominalBg")]
        ...
        [JsonProperty(PropertyName = "jenisGaransi")]
        public string JenisGaransi { get; set; }

        [JsonProperty(PropertyName = "jenisGaransiKet")]
        public string JenisGaransiKet { get; set; }

        [JsonProperty(PropertyName = "tanggalDiterbitkan")]
        ...
        [JsonProperty(PropertyName = "namaYangDijamin")]
        public double NamaYangDijamin { get; set; }
        ...
        [JsonProperty(PropertyName = "kodeTujuanGaransi")]
        public string KodeTujuanGaransi { get; set; }

        [JsonProperty(PropertyName = "tujuanGaransiKet")]
        public string TujuanGaransiKet { get; set; }

        [JsonProperty(PropertyName = "setoranJaminan")]
